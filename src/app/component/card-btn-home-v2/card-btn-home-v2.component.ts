...
@Component({
  selector: 'app-card-btn-home-v2',
  templateUrl: './card-btn-home-v2.component.html',
  styleUrls: ['./card-btn-home-v2.component.scss']
})
export class CardBtnHomeV2Component implements OnInit {
