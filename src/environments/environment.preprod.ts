const ip = "apim-mimov-sdm-preprod.movilidadbogota.gov.co";
...
export const environment = {
  ...
  version: "1.3.1.0",
  keyApiManager: "f0b695e4e3cd41d1b9e16bad9468263a",
  ...
  tableros: {
    registro: urlSeguridad + "fx-api-mimov-registro-sdm-preprod/registroReporte",
    graficasHome: urlSeguridad + "fx-api-mimov-cantidades-sdm-preprod/cantidades",
    catalogo: urlSeguridad + "fx-api-mimov-catalogo-sdm-preprod/catalogos",
    reporteGrafica: urlSeguridad + "fx-api-mimov-graficas-sdm-preprod/graficas",
    archivo: urlSeguridad + "fx-api-mimov-archivo-sdm-preprod/archivo",
  },
  ...
  consultarExceptuado: urlSeguridad+"fx-api-mimov-exceptuados-sdm-preprod/exceptuados",
  direccionamiento: {
    comparendos: {
